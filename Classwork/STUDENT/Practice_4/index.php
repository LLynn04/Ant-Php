    ...
    <div class="container mt-5">
        ...
        <form method="post">
            <table class="table table-bordered" style="max-width: 500px;">
                ...
                <tr>
                    <td colspan="2" class="text-center"><button type="submit" class="btn btn-primary">Add Product</button></td>
                </tr>
            </table>
        </form>
            ...
            <table class="table table-bordered" style="max-width: 500px;">
                ...
                <tbody>
                    ...
                    <tr>
                        <?php if ($item): ?>
                            <div class="mt-3">
                                <strong>Total Price (sum of all prices): </strong>
                                <?= number_format(totalPrice($item), 2) ?>$
                            </div>
                        <?php endif; ?>
                    </tr>
                </tbody>
